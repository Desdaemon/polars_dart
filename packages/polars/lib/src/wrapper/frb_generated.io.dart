...
class RustLibWire implements BaseWire {
  ...
  WireSyncRust2DartDco wire_Expr_exclude_dtype(
    ffi.Pointer<ffi.Void> that,
    ffi.Pointer<wire_cst_list_data_type> dtypes,
  ) {
    return _wire_Expr_exclude_dtype(
      that,
      dtypes,
    );
  }

  late final _wire_Expr_exclude_dtypePtr = _lookup<
          ffi.NativeFunction<
              WireSyncRust2DartDco Function(ffi.Pointer<ffi.Void>,
                  ffi.Pointer<wire_cst_list_data_type>)>>(
      'wire_Expr_exclude_dtype');
  late final _wire_Expr_exclude_dtype = _wire_Expr_exclude_dtypePtr.asFunction<
      WireSyncRust2DartDco Function(
          ffi.Pointer<ffi.Void>, ffi.Pointer<wire_cst_list_data_type>)>();
  ...
  void wire_Expr_what(
    ...
    return _wire_Expr_what(
      port_,
      that,
    );
  }

  late final _wire_Expr_whatPtr = _lookup<
          ffi
          .NativeFunction<ffi.Void Function(ffi.Int64, ffi.Pointer<ffi.Void>)>>(
      'wire_Expr_what');
  late final _wire_Expr_what = _wire_Expr_whatPtr
      .asFunction<void Function(int, ffi.Pointer<ffi.Void>)>();
  ...
  late final _wire_litPtr = _lookup<
      ffi.NativeFunction<
          WireSyncRust2DartDco Function(
              ffi.Pointer<wire_cst_literal_value>)>>('wire_lit');
  late final _wire_lit = _wire_litPtr.asFunction<
