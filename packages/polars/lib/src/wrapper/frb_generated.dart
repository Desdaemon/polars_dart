...
abstract class RustLibApi extends BaseApi {
  ...
  Expr exprExcludeDtype(
      {required Expr that, required List<DataType> dtypes, dynamic hint});
  ...
  Future<void> exprWhat({required Expr that, dynamic hint});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Expr exprExcludeDtype(
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        var arg0 = cst_encode_Auto_Owned_RustOpaque_stdsyncRwLockExpr(that);
        var arg1 = cst_encode_list_data_type(dtypes);
        return wire.wire_Expr_exclude_dtype(arg0, arg1);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_Auto_Owned_RustOpaque_stdsyncRwLockExpr,
        decodeErrorData: null,
      ),
      constMeta: kExprExcludeDtypeConstMeta,
      argValues: [that, dtypes],
      apiImpl: this,
      hint: hint,
    ));
  }

  TaskConstMeta get kExprExcludeDtypeConstMeta => const TaskConstMeta(
        debugName: "Expr_exclude_dtype",
        argNames: ["that", "dtypes"],
      );
  ...
  Future<void> exprWhat({required Expr that, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        var arg0 = cst_encode_Auto_Owned_RustOpaque_stdsyncRwLockExpr(that);
        return wire.wire_Expr_what(port_, arg0);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_unit,
        decodeErrorData: null,
      ),
      constMeta: kExprWhatConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kExprWhatConstMeta => const TaskConstMeta(
        debugName: "Expr_what",
        argNames: ["that"],
      );
